...
const FinanceReturn = () => {
    ...
    return (
        <Card className="financeReturn">
            <Card.Header className="financeReturnTitle">Financial Information</Card.Header>
            <Card.Body className="financeReturnBody">
                <Card.Text className="financeReturnText">
                    <DisplayBasicFinance className="financeReturnBasic"
                ...
                <Row>
                    <Col>
                        <Card className="eposReturn">
                            <Card.Header className="eposTitle">EPOS Records</Card.Header>
                    ...
                    <Col>
                        <Card className="atmReturn">
                            <Card.Header className="atmTitle">ATM Records</Card.Header>
